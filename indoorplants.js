...
const IndoorPlants = () => {
  ...
  const indoorPlants = [
    { img: "/static/zz.avif", title: "ZZ Plant", price: "₹400" },
    { img: "/static/bib.jfif", title: "Monstera Deliciosa", price: "₹550" },
    ...
    { img: "/static/fiddle.jfif", title: "Fiddle Leaf Fig", price: "₹600" },
    { img: "/static/snake.jfif", title: "Snake Plant", price: "₹250" },
    { img: "/static/boston.webp", title: "Boston Fern", price: "₹320" },
  ];
  ...
  const filteredPlants = indoorPlants.filter((plant) =>
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center text-success my-4">
        🏡 Indoor Plants - Bring Nature Inside 🌿
      </h2>
